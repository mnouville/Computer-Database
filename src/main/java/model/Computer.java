...
public class Computer {
	...
	public boolean validComputer() {
		...
		if ( this.getIntroduced() != null && this.getDiscontinued() != null ) {
			if ( this.getIntroduced().before(this.getDiscontinued()) ) { valid = true; } else { return false; }
		}
		if ( this.getName().equals("") ) { return false; }	else { valid = true; }
		return valid;
	}
	 ...
	 * @param company_id int that correspond to the Company Id of the Computer
	 */
	...
	public boolean equals(Computer c) {
		if ( this.id == c.getId() && this.name.equals(c.getName()) && this.introduced.equals(c.getIntroduced()) && this.discontinued.equals(c.getDiscontinued()) && this.company.equals(c.getCompany()))
			return true;
		else
			return false;
	}
	...
	/**
	 * toString method for the class Computer
	 * Have different utilities for the View part and for debugging
	...
	public String toString() {
		...
		s += "ID : " + this.id + 
			 ...
			 "\tCompany_id : " + this.company.toString();
		return s;
	}
}
