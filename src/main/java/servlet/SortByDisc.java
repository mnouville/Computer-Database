 ...
 */
@WebServlet(name = "SortByDisc", urlPatterns = { "/SortByDisc" })
public class SortByDisc extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      List<Dto> dtos;
      computers = this.serviceComputer.sortByColumn(request.getParameter("type"), offset,"discontinued");
      dtos = this.mapper.computersToDtos(computers);
      
      
      request.setAttribute("sort", "disc");
